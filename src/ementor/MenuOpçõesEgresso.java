 ...
 */
public class MenuOpçõesEgresso extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuOpçõesEgresso.class.getName());

    /**
     * Creates new form Cadastros
     */
    public MenuOpçõesEgresso() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuOpçõesEgresso().setVisible(true));
    }
