...
public class LoginInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ementor/capalogin.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ementor/logocadeado.png"))); // NOI18N
        jLabel1.setPreferredSize(new java.awt.Dimension(35, 35));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ementor/logouser.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String nomeDigitado = jTextField2.getText().trim();
        String senhaDigitada = new String(jPasswordField1.getPassword());

        if (nomeDigitado.isBlank() || senhaDigitada.isBlank()) {
            JOptionPane.showMessageDialog(this, "Preencha usuário e senha.", "Campo obrigatório", JOptionPane.WARNING_MESSAGE);
            return;
        }
