 ...
 */
public class ListaEgressos extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ListaEgressos.class.getName());

    /**
     * Creates new form Cadastros
     */
    public ListaEgressos() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ListaEgressos().setVisible(true));
    }
